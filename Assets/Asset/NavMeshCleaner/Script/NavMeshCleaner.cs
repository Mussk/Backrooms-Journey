    ...
    public void Build()
    {
       ...
       // Undo.RegisterCreatedObjectUndo(this, "build");
        ...
        for (int i = 0; i < m.Length || i == 0; i++)
        {
            ...
            {
                o = new GameObject();
                o.layer = LayerMask.NameToLayer(NavMeshLayerName);

                //o.hideFlags = HideFlags.DontSave;
                o.name = gameObject.name + "_Mesh(DontSave)";
                o.AddComponent<MeshFilter>();
                o.AddComponent<MeshCollider>();
                NavMeshModifier navMeshModifier = o.AddComponent<NavMeshModifier>();
                ...
                meshrenderer.sharedMaterial = Resources.Load<Material>("Materials/Black");
